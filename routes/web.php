...
Route::middleware(['web', \App\Http\Middleware\Localization::class])->group(function () {
    ...
    Route::controller(AuthController::class)->group(function () {
        ...
        Route::post('/register/phone/cancel', 'cancelGoogleRegistration')->name('register.phone.cancel');
    });
    ...
    Route::middleware('auth')->group(function () {
        ...
        // Settings (Broker company settings)
        Route::get('/settings', [SettingsController::class, 'edit'])->name('user.settings');
        Route::post('/settings', [SettingsController::class, 'store'])->name('user.settings.store');
